...
app.post('/api/create-order', async (req, res) => {
    ...
    try {
        ...
        if (bundleId) {
            ...
            // --- SINGLE COURSE FLOW ---
            const { data: courses } = await supabase.from('courses').select('id, name, price, discountPrice, term, exam_stages, tags').in('id', courseIds);
...
// ========== LEAD MAGNET: "ACCESS PDF" ==========
const LEAD_MAGNET_PDF_NAME = 'GenZ IITian Free Resource PDF';
const LEAD_MAGNET_DRIVE_LINK = 'https://drive.google.com/uc?export=download&id=1uKq2UKsIkdNiv3VKx2_BV_j2UXkjB2fA';
    ...
    try {
        ...
        if (supabase) {
            try {
                ...
                console.warn('[Lead Magnet] activity_logs notice:', e.message);
            }
        }
        ...
        res.json({
            ...
            drive_link: LEAD_MAGNET_DRIVE_LINK
        });
    } catch (err) {
