...
<body style="margin:0; padding:0; background-color:#e8f0fe; font-family:Arial, sans-serif;">
  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#e8f0fe; padding:24px 10px;">
    <tr>
      <td align="center">
        <table role="presentation" align="center" width="580" cellpadding="0" cellspacing="0" border="0" style="width:580px; max-width:580px; margin:0 auto; background:#ffffff; border:1px solid #c5d8f8; border-radius:14px; overflow:hidden;">
          <tr>
            <td style="background:#1a3a6e; padding:28px 24px 20px; text-align:center;">
              ...
              <p style="margin:0; color:#ffffff; font-family:Georgia,serif; font-size:24px; font-weight:700; line-height:1.4; white-space:nowrap;">
                Welcome to the Family! 🎓
              </p>
              <p style="margin:10px 0 0; color:#a8c4e8; font-size:14px; line-height:1.6; white-space:nowrap;">
        ...
        <table role="presentation" align="center" width="580" cellpadding="0" cellspacing="0" border="0" style="width:580px; max-width:580px; margin:0 auto; background:#ffffff; border:1px solid #c5d8f8; border-radius:14px; overflow:hidden;">
          <tr>
            <td style="background:#1a3a6e; padding:28px 20px 22px; text-align:center;">
              ...
              <p style="margin:0; color:#ffffff; font-family:Georgia,serif; font-size:22px; font-weight:700; line-height:1.3; white-space:nowrap;">
                You left something Behind &#128072;
              </p>
              <p style="margin:8px 0 0; color:#a8c4e8; font-size:14px; line-height:1.5; white-space:nowrap;">
...
<body style="margin:0; padding:0; background-color:#eef3fd; font-family:Arial, sans-serif;">
  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#eef3fd; padding:32px 12px;">
    <tr>
      <td align="center">
        <table role="presentation" align="center" width="580" cellpadding="0" cellspacing="0" border="0" style="width:580px; max-width:580px; margin:0 auto; background:#ffffff; border:1px solid #d0ddf5; border-radius:16px; overflow:hidden;">
          <tr>
